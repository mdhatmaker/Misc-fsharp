...
namespace MLPricePredictionML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\GitHub\Misc-csharp\MLPricePrediction\taxi-fare-train.txt";
        private static string MODEL_FILEPATH = @"../../../../MLPricePredictionML.Model/MLModel.zip";
